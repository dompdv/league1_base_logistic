...
import pprint
from build_1N2_from_history import prepare_logistic_regression
...
def simulate_bet_over(from_year_load, to_year_load, from_year, to_year, n_cat, matrices=None, printing='N'):
